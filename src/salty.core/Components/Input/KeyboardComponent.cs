...
namespace salty.core.Components.Input
{
    public class KeyboardComponent
    {
        ...
        /// </summary>
        public bool AltPressed => _currentKeyboardState.IsKeyDown(Keys.LeftAlt) || _currentKeyboardState.IsKeyDown(Keys.RightAlt);

        /// <summary>
        /// Return if any of the ctrl buttons is down.
        /// </summary>
        public bool CtrPressed => _currentKeyboardState.IsKeyDown(Keys.LeftControl) || _currentKeyboardState.IsKeyDown(Keys.RightControl);

        /// <summary>
        /// Return if any of the shift buttons is down.
        /// </summary>
        public bool ShiftPressed => _currentKeyboardState.IsKeyDown(Keys.LeftShift) || _currentKeyboardState.IsKeyDown(Keys.RightShift);

        /// <summary>
        /// Create the easy keyboard helper.
        /// </summary>
        public KeyboardComponent() => _previousKeyboardState = Keyboard.GetState();
        ...
        public bool IsKeyDown(Keys button) => _currentKeyboardState.IsKeyDown(button);
        ...
        public bool IsKeyUp(Keys button) => _currentKeyboardState.IsKeyUp(button);
        ...
        public bool PressedThisFrame(Keys button) => _currentKeyboardState.IsKeyDown(button) && _previousKeyboardState.IsKeyUp(button);
        ...
        public bool ReleasedThisFrame(Keys button) => _currentKeyboardState.IsKeyUp(button) && _previousKeyboardState.IsKeyDown(button);
    }
}